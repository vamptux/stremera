        ...
        <div className="px-4 py-4 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded border border-white/[0.06] bg-white/[0.02] px-3.5 py-2.5">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-zinc-500">Current</p>
              <p className="mt-0.5 text-sm font-semibold text-white tabular-nums">{currentLabel}</p>
            </div>
            <div className="rounded border border-white/[0.06] bg-white/[0.02] px-3.5 py-2.5">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-zinc-500">Latest</p>
          ...
          {updateState.errorMessage && !isUpdateAvailable && (
            <div className="rounded border border-red-500/20 bg-red-500/5 px-3.5 py-2.5">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-red-300/80">Error</p>
              <p className="mt-0.5 text-[12px] leading-relaxed text-red-100/80">{updateState.errorMessage}</p>
            </div>
          )}

          {pendingUpdate?.body && (
            <div className="rounded border border-white/[0.06] bg-white/[0.02] px-3.5 py-2.5">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-zinc-500">Release Notes</p>
              <p className="mt-1 text-[12px] leading-relaxed text-zinc-400 whitespace-pre-wrap">{pendingUpdate.body}</p>
            </div>
          )}
