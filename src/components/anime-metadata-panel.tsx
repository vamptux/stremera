              ...
              {characters.map((character) => (
                ...
                >
                  ...
                  <div className='flex flex-1 flex-col justify-center min-w-0'>
                    <span className='text-[13px] font-medium text-zinc-100 truncate leading-snug'>{character.name}</span>
                    {character.role && (
            ...
            <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3'>
              {staff.map((member) => (
                ...
                >
                  ...
                  <div className='flex flex-1 flex-col justify-center min-w-0'>
                    <span className='text-[13px] font-medium text-zinc-100 truncate leading-snug'>{member.name}</span>
                    <span
